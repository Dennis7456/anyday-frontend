...
<div className="container mx-auto shadow-sm rounded-lg">
        {/* <!-- headaer --> */}
...
{/* 
    ...
    {/* <!-- end header -->
    <!-- Chatting --> */}
    <div className="flex flex-row justify-between bg-white p-">
      {/* <!-- chat list --> */}
      <div className="flex flex-col w-2/5 border-r-2 overflow-y-auto">
        {/* <!-- search compt --> */}
        <div className="border-b-2 py-4 px-2 bg-white">
          <input
            type="text"
        ...
        <div className="flex flex-row py-4 px-2 items-center border-b-0">
          <div className="w-1/4">
            <img
              src="https://source.unsplash.com/vpOeXr5wmR4/600x600"
              className="object-cover h-12 w-12 rounded-full"
