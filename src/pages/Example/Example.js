        ...
        <div className="flex items-center">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              <a href="#" className="bg-on-surface-variant text-on-primary px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Dashboard</a>

              <a href="#" className="text-on-primary hover:bg-outline hover:text-white px-3 py-2 rounded-md text-sm font-medium">Team</a>

              <a href="#" className="text-on-primary hover:bg-outline hover:text-white px-3 py-2 rounded-md text-sm font-medium">Projects</a>

              <a href="#" className="text-on-primary hover:bg-outline hover:text-white px-3 py-2 rounded-md text-sm font-medium">Calendar</a>

              <a href="#" className="text-on-primary hover:bg-outline hover:text-white px-3 py-2 rounded-md text-sm font-medium">Reports</a>
            </div>
          </div>
        </div>
        <div className="hidden md:block">
