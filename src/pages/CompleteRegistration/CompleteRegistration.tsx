  ...
  return (
    <div>
      <div className="registration-container bg-gradient-to-r to-primary from-secondary-container h-full">
        <div className="text-2xl mx-[35px] py-[35px]">
          Complete Registration
        </div>
        <div className="flex flex-col items-start justify-center gap-[35px]">
          <div className="flex items-center justify-between gap-[35px] mx-[35px] px-[35px]">
            <div className="form-group flex flex-col gap-[12px]">
              <label className="text-sm">Email</label>
              <input
                className="w-[348px] h-[49px] border-[#E8E8ED] border-[2px] rounded-[3px] bg-gray-50 p-[10px] text-gray-500 focus:ring-gray-500 focus:border-gray-500 truncate ..."
                type="email"
                placeholder="Email"
                value={email}
            ...
            <div className="form-group flex flex-col gap-[12px]">
              <label className="text-sm">Type of Paper</label>
              <Select
                options={paperOptions}
                value={selectedPaperType}
                onChange={(option) =>
                  setSelectedPaperType(option as PaperOption)
                }
                styles={customStyles}
                className="react-select-container h-[49px] p-[10px]"
            ...
            <div className="form-group flex flex-col gap-[12px]">
              ...
              <div className="page-input-group h-[49px] flex">
                <button
                  type="button"
                  onClick={handleMinus}
                  className="p-[10px]"
                ...
                />
                <button type="button" onClick={handlePlus} className="p-[10px]">
            ...
            <div className="form-group flex flex-col gap-[12px]">
              ...
              <input
                ...
                required
                className="h-[49px] p-[10px]"
              />
            </div>
          </div>
          <div className="mx-[35px] px-[35px]">
            <form>
          ...
          <div className="mx-[35px] px-[35px]">Layer 3</div>
        </div>
      </div>
    </div>
    // <div className="registration-container">
    //   <form onSubmit={handleSubmit} className="registration-form p-4">
    //     <h2 className='text-2xl'>Complete Registration</h2>
